...
var bomb_collision, bombs, chain_explosions, check_collisions, drop_bomb, explode_bomb, explosion, explosions, extinguish_explosion, game_logic, game_over_screen, game_started, init_game, intro_screen, player_collision, players, shake_map, timer, update_map;
...
drop_bomb = function(x_pos, y_pos, pid) {
  return bombs.push({
    x: x_pos,
    y: y_pos,
    player_id: pid,
...
chain_explosions = function() {
  var explosions2b, index, _i, _len;
  for (_i = 0, _len = explosions2b.length; _i < _len; _i++) {
    index = explosions2b[_i];
    explode_bomb(index);
  }
  return explosions2b = [];
};
